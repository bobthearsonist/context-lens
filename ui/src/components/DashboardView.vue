...
// Pass the active scope so today's KPIs use the `*Since` deltas (see computeDashboardKpis).
const dashboardKpis = computed(() => computeDashboardKpis(todaySummaries.value, kpiScope.value))
